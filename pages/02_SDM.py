...
from views import tab_salesman_leaderboard, tab_cabang_leaderboard, tab_target_cabang, tab_target_salesman, tab_productivity, tab_segmentasi
...
# ── Tabs ──
tab_target_cabang_ui, tab_target_salesman_ui, tab_cabang_leaderboard_ui, tab_salesman_ui, tab_productivity_ui, tab_segmentasi_ui = st.tabs(
...
with tab_segmentasi_ui:
    tab_segmentasi.render(
        df_order, df_order_final, df_supply_final, df_customer_master, pilih_tahun, pilih_bulan,
        pilih_jenis, pilih_kelas, pilih_area, pilih_cabang, fmt_rp,
    )
